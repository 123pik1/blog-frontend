...
<div class="flex min-h-[60vh] items-center justify-center p-4">
	<div class="w-full max-w-md rounded-xl border-2 border-red-900 bg-[#1a1a1a] p-8 shadow-2xl">
		<div class="mb-8 text-center">
			<h1 class="text-3xl font-bold tracking-tight text-gray-100 uppercase">Sign In</h1>
			<p class="mt-2 text-sm text-gray-400">Access your blog dashboard</p>
		</div>
		...
		<form onsubmit={handleLogin} class="space-y-6">
			<div>
				<label
					for="username"
					class="block text-sm font-medium tracking-wider text-gray-400 uppercase">Username</label
				>
				<input
					type="text"
					id="username"
			...
			<div>
				<label
					for="password"
					class="block text-sm font-medium tracking-wider text-gray-400 uppercase">Password</label
				>
				<input
					type="password"
					id="password"
